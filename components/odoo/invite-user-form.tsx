...
import type { SeatType, InvitationMode, InstanceSeats } from "@/lib/types";
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <select
          ...
          title={t("langLabel")}
          className="rounded-btn border border-border bg-base px-2 text-small uppercase outline-none focus:border-accent focus:ring-2 focus:ring-accent/30"
        >
          {EMAIL_LANGS.map((l) => (
